...
public class UsuarioDaoImp implements UsuarioDao{
    ...
    /*public List<Map<String, Object>>validar(String x, String y){
    	String SQL = "SELECT r.idrol, r.nom_rol, u.idusuario, u.nom_user, u.clave FROM USUARIO u, ROL r WHERE u.nom_user=? and u.clave=? and r.idrol =u.idrol";
